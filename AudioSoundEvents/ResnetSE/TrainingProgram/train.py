...
def main(args):
    ...
    #
    net = SED(args.num_label, args.fft.n_mel, pooling_type='TAP')
    ...
    scheduler = WarmupCosineSchedulerLR(optimizer=optimizer, fix_epoch=args.epochs, step_per_epoch=len(tr_loader),
